...
const suscripcionValidations = {
  validarSuscripcion: [
    body("nombre")
      .notEmpty()
      .withMessage("El nombre de la suscripción es obligatorio")
      .isString()
  ...
  validarId: [
    param("id").isMongoId().withMessage("El ID de la suscripción no es válido"),
  ],
};

module.exports = suscripcionValidations;
